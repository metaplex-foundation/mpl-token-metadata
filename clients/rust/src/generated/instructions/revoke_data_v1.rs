...
pub struct RevokeDataV1CpiAccounts<'a> {
    /// Delegate record account
...
impl<'a> RevokeDataV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeDataV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeDataV1CpiBuilder<'a> {
    instruction: Box<RevokeDataV1CpiBuilderInstruction<'a>>,
}
...
struct RevokeDataV1CpiBuilderInstruction<'a> {
