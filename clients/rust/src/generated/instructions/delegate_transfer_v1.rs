...
pub struct DelegateTransferV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateTransferV1Cpi<'a> {
...
impl<'a> DelegateTransferV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateTransferV1CpiAccounts<'a>,
        args: DelegateTransferV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateTransferV1CpiBuilder<'a> {
    instruction: Box<DelegateTransferV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateTransferV1CpiBuilder<'a> {
...
struct DelegateTransferV1CpiBuilderInstruction<'a> {
