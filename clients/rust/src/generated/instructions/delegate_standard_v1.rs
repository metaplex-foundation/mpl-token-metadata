...
pub struct DelegateStandardV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateStandardV1Cpi<'a> {
...
impl<'a> DelegateStandardV1Cpi<'a> {
    pub fn new(
        ...
        accounts: DelegateStandardV1CpiAccounts<'a>,
        args: DelegateStandardV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateStandardV1CpiBuilder<'a> {
    instruction: Box<DelegateStandardV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateStandardV1CpiBuilder<'a> {
...
struct DelegateStandardV1CpiBuilderInstruction<'a> {
