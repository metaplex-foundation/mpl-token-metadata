...
impl UpdateAsDataItemDelegateV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateAsDataItemDelegateV2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct UpdateAsDataItemDelegateV2Builder {
    ...
    data: Option<UpdateAsDataItemDelegateV2InstructionDataData>,
...
impl UpdateAsDataItemDelegateV2Builder {
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn data(&mut self, data: UpdateAsDataItemDelegateV2InstructionDataData) -> &mut Self {
        self.data = Some(data);
        self
    }
    /// `[optional argument]`
...
pub struct UpdateAsDataItemDelegateV2CpiAccounts<'a> {
    /// Update authority or delegate
...
pub struct UpdateAsDataItemDelegateV2Cpi<'a> {
...
impl<'a> UpdateAsDataItemDelegateV2Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateAsDataItemDelegateV2CpiAccounts<'a>,
        args: UpdateAsDataItemDelegateV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// `update_as_data_item_delegate_v2` CPI instruction builder.
pub struct UpdateAsDataItemDelegateV2CpiBuilder<'a> {
    instruction: Box<UpdateAsDataItemDelegateV2CpiBuilderInstruction<'a>>,
}

impl<'a> UpdateAsDataItemDelegateV2CpiBuilder<'a> {
...
struct UpdateAsDataItemDelegateV2CpiBuilderInstruction<'a> {
