...
/// Accounts.
pub struct DelegateLockedTransferV1 {
...
/// Instruction builder for `DelegateLockedTransferV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct DelegateLockedTransferV1Builder {
...
impl DelegateLockedTransferV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DelegateLockedTransferV1 {
...
/// Instruction builder for `DelegateLockedTransferV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, optional]` delegate_record
...
impl<'a, 'b> DelegateLockedTransferV1CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = DelegateLockedTransferV1Cpi {
