...
impl RevokeMigrationV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = RevokeMigrationV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
struct RevokeMigrationV1InstructionData {
    discriminator: u8,
    revoke_migration_v1_discriminator: u8,
}

impl RevokeMigrationV1InstructionData {
    fn new() -> Self {
        Self {
            discriminator: 45,
            revoke_migration_v1_discriminator: 9,
        }
    }
}
...
impl RevokeMigrationV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RevokeMigrationV1 {
...
/// `revoke_migration_v1` CPI accounts.
pub struct RevokeMigrationV1CpiAccounts<'a> {
    /// Delegate record account
...
/// `revoke_migration_v1` CPI instruction.
pub struct RevokeMigrationV1Cpi<'a> {
...
impl<'a> RevokeMigrationV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeMigrationV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeMigrationV1CpiBuilder<'a> {
    instruction: Box<RevokeMigrationV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeMigrationV1CpiBuilder<'a> {
    pub fn new(program: &'a solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RevokeMigrationV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RevokeMigrationV1Cpi {
...
struct RevokeMigrationV1CpiBuilderInstruction<'a> {
