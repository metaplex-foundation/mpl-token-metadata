...
impl RevokeMigrationV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeMigrationV1InstructionArgs::new();
...
struct RevokeMigrationV1InstructionArgs {
    discriminator: u8,
    revoke_migration_v1_discriminator: u8,
}

impl RevokeMigrationV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
impl<'a> RevokeMigrationV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeMigrationV1Cpi<'a> {
        RevokeMigrationV1Cpi {
