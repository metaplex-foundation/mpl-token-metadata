...
pub struct RevokeStandardV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct RevokeStandardV1Cpi<'a> {
...
impl<'a> RevokeStandardV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeStandardV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeStandardV1CpiBuilder<'a> {
    instruction: Box<RevokeStandardV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeStandardV1CpiBuilder<'a> {
...
struct RevokeStandardV1CpiBuilderInstruction<'a> {
