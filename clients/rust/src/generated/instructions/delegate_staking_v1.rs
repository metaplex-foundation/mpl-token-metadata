...
pub struct DelegateStakingV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateStakingV1Cpi<'a> {
...
impl<'a> DelegateStakingV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateStakingV1CpiAccounts<'a>,
        args: DelegateStakingV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateStakingV1CpiBuilder<'a> {
    instruction: Box<DelegateStakingV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateStakingV1CpiBuilder<'a> {
...
struct DelegateStakingV1CpiBuilderInstruction<'a> {
