...
use crate::generated::types::UnlockArgs;
...
impl Unlock {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UnlockInstructionData::new().try_to_vec().unwrap();
...
pub struct UnlockInstructionArgs {
...
impl UnlockBuilder {
    ...
    #[inline(always)]
    pub fn unlock_args(&mut self, unlock_args: UnlockArgs) -> &mut Self {
        self.unlock_args = Some(unlock_args);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = UnlockInstructionArgs {
            unlock_args: self.unlock_args.clone().expect("unlock_args is not set"),
        };
...
pub struct UnlockCpi<'a, 'b> {
    ...
    pub __args: UnlockInstructionArgs,
}
...
/// `unlock` CPI instruction builder.
...
impl<'a, 'b> UnlockCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn unlock_args(&mut self, unlock_args: UnlockArgs) -> &mut Self {
        self.instruction.unlock_args = Some(unlock_args);
        self
    }
