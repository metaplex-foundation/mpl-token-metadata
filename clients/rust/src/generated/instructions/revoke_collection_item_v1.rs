...
impl RevokeCollectionItemV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeCollectionItemV1InstructionArgs::new();
...
struct RevokeCollectionItemV1InstructionArgs {
    discriminator: u8,
    revoke_collection_item_v1_discriminator: u8,
}

impl RevokeCollectionItemV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
pub struct RevokeCollectionItemV1Cpi<'a> {
...
pub struct RevokeCollectionItemV1CpiBuilder<'a> {
    instruction: Box<RevokeCollectionItemV1CpiBuilderInstruction<'a>>,
}
...
struct RevokeCollectionItemV1CpiBuilderInstruction<'a> {
