...
pub struct DelegateDataItemV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateDataItemV1Cpi<'a> {
...
impl<'a> DelegateDataItemV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateDataItemV1CpiAccounts<'a>,
        args: DelegateDataItemV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateDataItemV1CpiBuilder<'a> {
    instruction: Box<DelegateDataItemV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateDataItemV1CpiBuilder<'a> {
...
struct DelegateDataItemV1CpiBuilderInstruction<'a> {
