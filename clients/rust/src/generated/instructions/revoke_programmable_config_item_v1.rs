...
impl RevokeProgrammableConfigItemV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeProgrammableConfigItemV1InstructionArgs::new();
...
struct RevokeProgrammableConfigItemV1InstructionArgs {
    discriminator: u8,
    revoke_programmable_config_item_v1_discriminator: u8,
}

impl RevokeProgrammableConfigItemV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
impl<'a> RevokeProgrammableConfigItemV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeProgrammableConfigItemV1Cpi<'a> {
        RevokeProgrammableConfigItemV1Cpi {
