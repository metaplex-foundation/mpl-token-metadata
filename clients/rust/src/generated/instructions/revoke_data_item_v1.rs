...
/// Instruction builder for `RevokeDataItemV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct RevokeDataItemV1Builder {
...
/// `revoke_data_item_v1` CPI accounts.
pub struct RevokeDataItemV1CpiAccounts<'a, 'b> {
    /// Delegate record account
...
/// `revoke_data_item_v1` CPI instruction.
pub struct RevokeDataItemV1Cpi<'a, 'b> {
...
impl<'a, 'b> RevokeDataItemV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeDataItemV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RevokeDataItemV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, optional]` delegate_record
...
///   12. `[optional]` authorization_rules_program
///   13. `[optional]` authorization_rules
pub struct RevokeDataItemV1CpiBuilder<'a, 'b> {
    instruction: Box<RevokeDataItemV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RevokeDataItemV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RevokeDataItemV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RevokeDataItemV1Cpi {
...
struct RevokeDataItemV1CpiBuilderInstruction<'a, 'b> {
