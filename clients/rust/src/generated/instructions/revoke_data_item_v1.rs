...
impl RevokeDataItemV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeDataItemV1InstructionArgs::new();
...
struct RevokeDataItemV1InstructionArgs {
    discriminator: u8,
    revoke_data_item_v1_discriminator: u8,
}

impl RevokeDataItemV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
pub struct RevokeDataItemV1Cpi<'a> {
...
pub struct RevokeDataItemV1CpiBuilder<'a> {
    instruction: Box<RevokeDataItemV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeDataItemV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeDataItemV1Cpi<'a> {
        RevokeDataItemV1Cpi {
...
struct RevokeDataItemV1CpiBuilderInstruction<'a> {
