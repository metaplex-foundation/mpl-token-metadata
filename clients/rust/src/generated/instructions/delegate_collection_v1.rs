...
pub struct DelegateCollectionV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateCollectionV1Cpi<'a> {
...
impl<'a> DelegateCollectionV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateCollectionV1CpiAccounts<'a>,
        args: DelegateCollectionV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateCollectionV1CpiBuilder<'a> {
    instruction: Box<DelegateCollectionV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateCollectionV1CpiBuilder<'a> {
...
struct DelegateCollectionV1CpiBuilderInstruction<'a> {
