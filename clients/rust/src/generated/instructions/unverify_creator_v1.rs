...
pub struct UnverifyCreatorV1CpiAccounts<'a> {
    /// Creator to verify, collection (or metadata if parent burned) update authority or delegate
...
pub struct UnverifyCreatorV1Cpi<'a> {
...
impl<'a> UnverifyCreatorV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: UnverifyCreatorV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct UnverifyCreatorV1CpiBuilder<'a> {
    instruction: Box<UnverifyCreatorV1CpiBuilderInstruction<'a>>,
}

impl<'a> UnverifyCreatorV1CpiBuilder<'a> {
...
struct UnverifyCreatorV1CpiBuilderInstruction<'a> {
