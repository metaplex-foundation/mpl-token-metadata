...
pub struct DelegateUtilityV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateUtilityV1Cpi<'a> {
...
impl<'a> DelegateUtilityV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateUtilityV1CpiAccounts<'a>,
        args: DelegateUtilityV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateUtilityV1CpiBuilder<'a> {
    instruction: Box<DelegateUtilityV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateUtilityV1CpiBuilder<'a> {
...
struct DelegateUtilityV1CpiBuilderInstruction<'a> {
