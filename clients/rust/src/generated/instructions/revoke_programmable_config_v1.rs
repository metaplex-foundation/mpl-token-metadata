...
impl RevokeProgrammableConfigV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeProgrammableConfigV1InstructionArgs::new();
...
struct RevokeProgrammableConfigV1InstructionArgs {
    discriminator: u8,
    revoke_programmable_config_v1_discriminator: u8,
}

impl RevokeProgrammableConfigV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
impl<'a> RevokeProgrammableConfigV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeProgrammableConfigV1Cpi<'a> {
        RevokeProgrammableConfigV1Cpi {
