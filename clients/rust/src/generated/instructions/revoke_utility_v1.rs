...
impl RevokeUtilityV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeUtilityV1InstructionArgs::new();
...
struct RevokeUtilityV1InstructionArgs {
    discriminator: u8,
    revoke_utility_v1_discriminator: u8,
}

impl RevokeUtilityV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
impl<'a> RevokeUtilityV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeUtilityV1Cpi<'a> {
        RevokeUtilityV1Cpi {
