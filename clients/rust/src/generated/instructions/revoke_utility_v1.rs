...
pub struct RevokeUtilityV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct RevokeUtilityV1Cpi<'a> {
...
impl<'a> RevokeUtilityV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeUtilityV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeUtilityV1CpiBuilder<'a> {
    instruction: Box<RevokeUtilityV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeUtilityV1CpiBuilder<'a> {
...
struct RevokeUtilityV1CpiBuilderInstruction<'a> {
