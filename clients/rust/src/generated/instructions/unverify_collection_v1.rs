...
/// `unverify_collection_v1` CPI accounts.
pub struct UnverifyCollectionV1CpiAccounts<'a, 'b> {
    /// Creator to verify, collection (or metadata if parent burned) update authority or delegate
...
pub struct UnverifyCollectionV1Cpi<'a, 'b> {
...
impl<'a, 'b> UnverifyCollectionV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UnverifyCollectionV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UnverifyCollectionV1` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct UnverifyCollectionV1CpiBuilder<'a, 'b> {
    instruction: Box<UnverifyCollectionV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UnverifyCollectionV1CpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = UnverifyCollectionV1Cpi {
...
struct UnverifyCollectionV1CpiBuilderInstruction<'a, 'b> {
