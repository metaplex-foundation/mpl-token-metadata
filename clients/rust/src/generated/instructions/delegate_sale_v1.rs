...
pub struct DelegateSaleV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct DelegateSaleV1Cpi<'a> {
...
impl<'a> DelegateSaleV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateSaleV1CpiAccounts<'a>,
        args: DelegateSaleV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateSaleV1CpiBuilder<'a> {
    instruction: Box<DelegateSaleV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateSaleV1CpiBuilder<'a> {
...
struct DelegateSaleV1CpiBuilderInstruction<'a> {
