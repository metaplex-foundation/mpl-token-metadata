...
impl DelegateProgrammableConfigV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = DelegateProgrammableConfigV1InstructionArgs::new();
...
struct DelegateProgrammableConfigV1InstructionArgs {
    discriminator: u8,
    delegate_programmable_config_v1_discriminator: u8,
    pub authorization_data: Option<AuthorizationData>,
}

impl DelegateProgrammableConfigV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 44,
