...
impl RevokeStakingV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeStakingV1InstructionArgs::new();
...
struct RevokeStakingV1InstructionArgs {
    discriminator: u8,
    revoke_staking_v1_discriminator: u8,
}

impl RevokeStakingV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
pub struct RevokeStakingV1Cpi<'a> {
...
pub struct RevokeStakingV1CpiBuilder<'a> {
    instruction: Box<RevokeStakingV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeStakingV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeStakingV1Cpi<'a> {
        RevokeStakingV1Cpi {
...
struct RevokeStakingV1CpiBuilderInstruction<'a> {
