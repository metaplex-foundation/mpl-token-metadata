...
pub struct RevokeSaleV1CpiAccounts<'a> {
    /// Delegate record account
...
impl<'a> RevokeSaleV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeSaleV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeSaleV1CpiBuilder<'a> {
    instruction: Box<RevokeSaleV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeSaleV1CpiBuilder<'a> {
...
struct RevokeSaleV1CpiBuilderInstruction<'a> {
