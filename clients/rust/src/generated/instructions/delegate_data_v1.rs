...
impl DelegateDataV1 {
    pub fn instruction(
        &self,
        args: DelegateDataV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DelegateDataV1InstructionData::new().try_to_vec().unwrap();
...
pub struct DelegateDataV1InstructionArgs {
...
impl DelegateDataV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = DelegateDataV1InstructionArgs {
...
/// `delegate_data_v1` CPI accounts.
pub struct DelegateDataV1CpiAccounts<'a> {
    /// Delegate record account
...
/// `delegate_data_v1` CPI instruction.
pub struct DelegateDataV1Cpi<'a> {
...
impl<'a> DelegateDataV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateDataV1CpiAccounts<'a>,
        args: DelegateDataV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
pub struct DelegateDataV1CpiBuilder<'a> {
    instruction: Box<DelegateDataV1CpiBuilderInstruction<'a>>,
}

impl<'a> DelegateDataV1CpiBuilder<'a> {
    pub fn new(program: &'a solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelegateDataV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DelegateDataV1Cpi {
...
struct DelegateDataV1CpiBuilderInstruction<'a> {
