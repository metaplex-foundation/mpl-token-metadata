...
pub struct RevokeCollectionV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct RevokeCollectionV1Cpi<'a> {
...
impl<'a> RevokeCollectionV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeCollectionV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeCollectionV1CpiBuilder<'a> {
    instruction: Box<RevokeCollectionV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeCollectionV1CpiBuilder<'a> {
...
struct RevokeCollectionV1CpiBuilderInstruction<'a> {
