...
pub struct RevokeLockedTransferV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct RevokeLockedTransferV1Cpi<'a> {
...
impl<'a> RevokeLockedTransferV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeLockedTransferV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeLockedTransferV1CpiBuilder<'a> {
    instruction: Box<RevokeLockedTransferV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeLockedTransferV1CpiBuilder<'a> {
...
struct RevokeLockedTransferV1CpiBuilderInstruction<'a> {
