...
pub struct RevokeAuthorityItemV1CpiAccounts<'a> {
    /// Delegate record account
...
pub struct RevokeAuthorityItemV1Cpi<'a> {
...
impl<'a> RevokeAuthorityItemV1Cpi<'a> {
    pub fn new(
        program: &'a solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeAuthorityItemV1CpiAccounts<'a>,
    ) -> Self {
        Self {
            __program: program,
...
pub struct RevokeAuthorityItemV1CpiBuilder<'a> {
    instruction: Box<RevokeAuthorityItemV1CpiBuilderInstruction<'a>>,
}

impl<'a> RevokeAuthorityItemV1CpiBuilder<'a> {
...
struct RevokeAuthorityItemV1CpiBuilderInstruction<'a> {
