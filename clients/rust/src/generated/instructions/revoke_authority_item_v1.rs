...
impl RevokeAuthorityItemV1 {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let args = RevokeAuthorityItemV1InstructionArgs::new();
...
struct RevokeAuthorityItemV1InstructionArgs {
    discriminator: u8,
    revoke_authority_item_v1_discriminator: u8,
}

impl RevokeAuthorityItemV1InstructionArgs {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
impl<'a> RevokeAuthorityItemV1CpiBuilder<'a> {
    ...
    #[allow(clippy::clone_on_copy)]
    pub fn build(&self) -> RevokeAuthorityItemV1Cpi<'a> {
        RevokeAuthorityItemV1Cpi {
