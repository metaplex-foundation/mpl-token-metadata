...
export type DelegateDataItemV1Instruction<
...
export function getDelegateDataItemV1InstructionDataEncoder(): Encoder<DelegateDataItemV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['delegateDataItemV1Discriminator', getU8Encoder()],
      ['authorizationData', getOptionEncoder(getAuthorizationDataEncoder())],
    ]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_DATA_ITEM_V1_DISCRIMINATOR,
...
export function getDelegateDataItemV1InstructionDataDecoder(): Decoder<DelegateDataItemV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateDataItemV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateDataItemV1InstructionDataCodec(): Codec<
  DelegateDataItemV1InstructionDataArgs,
  DelegateDataItemV1InstructionData
> {
  return combineCodec(
    getDelegateDataItemV1InstructionDataEncoder(),
    getDelegateDataItemV1InstructionDataDecoder()
  );
}
...
export type DelegateDataItemV1AsyncInput<
...
> = {
  ...
  authorizationData?: DelegateDataItemV1InstructionDataArgs['authorizationData'];
  tokenStandard: DelegateDataItemV1InstructionExtraArgs['tokenStandard'];
  updateAuthority?: DelegateDataItemV1InstructionExtraArgs['updateAuthority'];
};

export async function getDelegateDataItemV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateDataItemV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDelegateDataItemV1InstructionDataEncoder().encode(
      args as DelegateDataItemV1InstructionDataArgs
    ),
    programAddress,
  } as DelegateDataItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateDataItemV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateDataItemV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedDelegateDataItemV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateDataItemV1InstructionData;
};

export function parseDelegateDataItemV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegateDataItemV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateDataItemV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
