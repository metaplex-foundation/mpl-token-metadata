...
export type RevokeDataV1Instruction<
...
export function getRevokeDataV1InstructionDataEncoder(): FixedSizeEncoder<RevokeDataV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['revokeDataV1Discriminator', getU8Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REVOKE_DATA_V1_DISCRIMINATOR,
      revokeDataV1Discriminator: 3,
    })
  );
}

export function getRevokeDataV1InstructionDataDecoder(): FixedSizeDecoder<RevokeDataV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['revokeDataV1Discriminator', getU8Decoder()],
  ]);
}

export function getRevokeDataV1InstructionDataCodec(): FixedSizeCodec<
  RevokeDataV1InstructionDataArgs,
  RevokeDataV1InstructionData
> {
  return combineCodec(
    getRevokeDataV1InstructionDataEncoder(),
    getRevokeDataV1InstructionDataDecoder()
  );
}
...
export type RevokeDataV1AsyncInput<
...
> = {
  ...
  tokenStandard: RevokeDataV1InstructionExtraArgs['tokenStandard'];
  updateAuthority?: RevokeDataV1InstructionExtraArgs['updateAuthority'];
};

export async function getRevokeDataV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRevokeDataV1InstructionDataEncoder().encode({}),
    programAddress,
  } as RevokeDataV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export function getRevokeDataV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedRevokeDataV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RevokeDataV1InstructionData;
};

export function parseRevokeDataV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevokeDataV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRevokeDataV1InstructionDataDecoder().decode(instruction.data),
  };
}
