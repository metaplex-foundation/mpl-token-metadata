...
export type RevokeUtilityV1Instruction<
...
export function getRevokeUtilityV1InstructionDataEncoder(): FixedSizeEncoder<RevokeUtilityV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['revokeUtilityV1Discriminator', getU8Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REVOKE_UTILITY_V1_DISCRIMINATOR,
      revokeUtilityV1Discriminator: 4,
    })
  );
}

export function getRevokeUtilityV1InstructionDataDecoder(): FixedSizeDecoder<RevokeUtilityV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['revokeUtilityV1Discriminator', getU8Decoder()],
  ]);
}

export function getRevokeUtilityV1InstructionDataCodec(): FixedSizeCodec<
  RevokeUtilityV1InstructionDataArgs,
  RevokeUtilityV1InstructionData
> {
  return combineCodec(
    getRevokeUtilityV1InstructionDataEncoder(),
    getRevokeUtilityV1InstructionDataDecoder()
  );
}
...
export type RevokeUtilityV1AsyncInput<
...
> = {
  ...
  tokenStandard: RevokeUtilityV1InstructionExtraArgs['tokenStandard'];
  tokenOwner?: RevokeUtilityV1InstructionExtraArgs['tokenOwner'];
};

export async function getRevokeUtilityV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: RevokeUtilityV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getRevokeUtilityV1InstructionDataEncoder().encode({}),
  } as RevokeUtilityV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type RevokeUtilityV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getRevokeUtilityV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedRevokeUtilityV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RevokeUtilityV1InstructionData;
};

export function parseRevokeUtilityV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevokeUtilityV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRevokeUtilityV1InstructionDataDecoder().decode(instruction.data),
  };
}
