...
export type DelegateProgrammableConfigV1Instruction<
...
export function getDelegateProgrammableConfigV1InstructionDataEncoder(): Encoder<DelegateProgrammableConfigV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['delegateProgrammableConfigV1Discriminator', getU8Encoder()],
...
export function getDelegateProgrammableConfigV1InstructionDataDecoder(): Decoder<DelegateProgrammableConfigV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateProgrammableConfigV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateProgrammableConfigV1InstructionDataCodec(): Codec<
  DelegateProgrammableConfigV1InstructionDataArgs,
  DelegateProgrammableConfigV1InstructionData
> {
  return combineCodec(
    getDelegateProgrammableConfigV1InstructionDataEncoder(),
    getDelegateProgrammableConfigV1InstructionDataDecoder()
  );
}
...
>(
  input: DelegateProgrammableConfigV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateProgrammableConfigV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDelegateProgrammableConfigV1InstructionDataEncoder().encode(
      args as DelegateProgrammableConfigV1InstructionDataArgs
    ),
    programAddress,
  } as DelegateProgrammableConfigV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateProgrammableConfigV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateProgrammableConfigV1Instruction<
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: DelegateProgrammableConfigV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedDelegateProgrammableConfigV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateProgrammableConfigV1InstructionData;
};

export function parseDelegateProgrammableConfigV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegateProgrammableConfigV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateProgrammableConfigV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
