...
export type RevokeSaleV1Instruction<
...
export function getRevokeSaleV1InstructionDataEncoder(): FixedSizeEncoder<RevokeSaleV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['revokeSaleV1Discriminator', getU8Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REVOKE_SALE_V1_DISCRIMINATOR,
      revokeSaleV1Discriminator: 1,
    })
  );
}

export function getRevokeSaleV1InstructionDataDecoder(): FixedSizeDecoder<RevokeSaleV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['revokeSaleV1Discriminator', getU8Decoder()],
  ]);
}

export function getRevokeSaleV1InstructionDataCodec(): FixedSizeCodec<
  RevokeSaleV1InstructionDataArgs,
  RevokeSaleV1InstructionData
> {
  return combineCodec(
    getRevokeSaleV1InstructionDataEncoder(),
    getRevokeSaleV1InstructionDataDecoder()
  );
}
...
export type RevokeSaleV1AsyncInput<
...
> = {
  ...
  tokenStandard: RevokeSaleV1InstructionExtraArgs['tokenStandard'];
  tokenOwner?: RevokeSaleV1InstructionExtraArgs['tokenOwner'];
};

export async function getRevokeSaleV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRevokeSaleV1InstructionDataEncoder().encode({}),
    programAddress,
  } as RevokeSaleV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export function getRevokeSaleV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedRevokeSaleV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RevokeSaleV1InstructionData;
};

export function parseRevokeSaleV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevokeSaleV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRevokeSaleV1InstructionDataDecoder().decode(instruction.data),
  };
}
