...
export function getRevokeProgrammableConfigV1InstructionDataEncoder(): FixedSizeEncoder<RevokeProgrammableConfigV1InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: REVOKE_PROGRAMMABLE_CONFIG_V1_DISCRIMINATOR,
      revokeProgrammableConfigV1Discriminator: 8,
    })
  );
}

export function getRevokeProgrammableConfigV1InstructionDataDecoder(): FixedSizeDecoder<RevokeProgrammableConfigV1InstructionData> {
...
export function getRevokeProgrammableConfigV1InstructionDataCodec(): FixedSizeCodec<
...
> = {
  ...
  tokenStandard: RevokeProgrammableConfigV1InstructionExtraArgs['tokenStandard'];
