...
export type RevokeAuthorityItemV1Instruction<
...
export function getRevokeAuthorityItemV1InstructionDataEncoder(): FixedSizeEncoder<RevokeAuthorityItemV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['revokeAuthorityItemV1Discriminator', getU8Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REVOKE_AUTHORITY_ITEM_V1_DISCRIMINATOR,
      revokeAuthorityItemV1Discriminator: 10,
    })
  );
}

export function getRevokeAuthorityItemV1InstructionDataDecoder(): FixedSizeDecoder<RevokeAuthorityItemV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['revokeAuthorityItemV1Discriminator', getU8Decoder()],
  ]);
}

export function getRevokeAuthorityItemV1InstructionDataCodec(): FixedSizeCodec<
  RevokeAuthorityItemV1InstructionDataArgs,
  RevokeAuthorityItemV1InstructionData
> {
  return combineCodec(
    getRevokeAuthorityItemV1InstructionDataEncoder(),
    getRevokeAuthorityItemV1InstructionDataDecoder()
  );
}
...
export type RevokeAuthorityItemV1AsyncInput<
...
> = {
  ...
  tokenStandard: RevokeAuthorityItemV1InstructionExtraArgs['tokenStandard'];
  updateAuthority?: RevokeAuthorityItemV1InstructionExtraArgs['updateAuthority'];
};

export async function getRevokeAuthorityItemV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: RevokeAuthorityItemV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  RevokeAuthorityItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRevokeAuthorityItemV1InstructionDataEncoder().encode({}),
    programAddress,
  } as RevokeAuthorityItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type RevokeAuthorityItemV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getRevokeAuthorityItemV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: RevokeAuthorityItemV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedRevokeAuthorityItemV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RevokeAuthorityItemV1InstructionData;
};

export function parseRevokeAuthorityItemV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevokeAuthorityItemV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRevokeAuthorityItemV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
