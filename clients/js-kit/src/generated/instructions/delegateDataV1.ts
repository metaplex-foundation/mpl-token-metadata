...
export type DelegateDataV1Instruction<
...
export function getDelegateDataV1InstructionDataEncoder(): Encoder<DelegateDataV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['delegateDataV1Discriminator', getU8Encoder()],
      ['authorizationData', getOptionEncoder(getAuthorizationDataEncoder())],
    ]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_DATA_V1_DISCRIMINATOR,
...
export function getDelegateDataV1InstructionDataDecoder(): Decoder<DelegateDataV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateDataV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateDataV1InstructionDataCodec(): Codec<
  DelegateDataV1InstructionDataArgs,
  DelegateDataV1InstructionData
> {
  return combineCodec(
    getDelegateDataV1InstructionDataEncoder(),
    getDelegateDataV1InstructionDataDecoder()
  );
}
...
export type DelegateDataV1AsyncInput<
...
> = {
  ...
  authorizationData?: DelegateDataV1InstructionDataArgs['authorizationData'];
  tokenStandard: DelegateDataV1InstructionExtraArgs['tokenStandard'];
  updateAuthority?: DelegateDataV1InstructionExtraArgs['updateAuthority'];
};

export async function getDelegateDataV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateDataV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegateDataV1InstructionDataEncoder().encode(
      args as DelegateDataV1InstructionDataArgs
    ),
  } as DelegateDataV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateDataV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateDataV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedDelegateDataV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateDataV1InstructionData;
};

export function parseDelegateDataV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegateDataV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateDataV1InstructionDataDecoder().decode(instruction.data),
  };
}
