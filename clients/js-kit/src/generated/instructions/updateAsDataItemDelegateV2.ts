...
export type UpdateAsDataItemDelegateV2Instruction<
...
export function getUpdateAsDataItemDelegateV2InstructionDataEncoder(): Encoder<UpdateAsDataItemDelegateV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['updateAsDataItemDelegateV2Discriminator', getU8Encoder()],
...
export function getUpdateAsDataItemDelegateV2InstructionDataDecoder(): Decoder<UpdateAsDataItemDelegateV2InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['updateAsDataItemDelegateV2Discriminator', getU8Decoder()],
    ['data', getOptionDecoder(getDataDecoder())],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getUpdateAsDataItemDelegateV2InstructionDataCodec(): Codec<
  UpdateAsDataItemDelegateV2InstructionDataArgs,
  UpdateAsDataItemDelegateV2InstructionData
> {
  return combineCodec(
    getUpdateAsDataItemDelegateV2InstructionDataEncoder(),
    getUpdateAsDataItemDelegateV2InstructionDataDecoder()
  );
}
...
>(
  input: UpdateAsDataItemDelegateV2AsyncInput<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsDataItemDelegateV2Instruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
> {
  ...
  return Object.freeze({
    ...
    data: getUpdateAsDataItemDelegateV2InstructionDataEncoder().encode(
      args as UpdateAsDataItemDelegateV2InstructionDataArgs
    ),
    programAddress,
  } as UpdateAsDataItemDelegateV2Instruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
export type UpdateAsDataItemDelegateV2Input<
  TAccountAuthority extends string = string,
  TAccountDelegateRecord extends string = string,
  TAccountToken extends string = string,
  TAccountMint extends string = string,
...
export function getUpdateAsDataItemDelegateV2Instruction<
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: UpdateAsDataItemDelegateV2Input<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export type ParsedUpdateAsDataItemDelegateV2Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: UpdateAsDataItemDelegateV2InstructionData;
};

export function parseUpdateAsDataItemDelegateV2Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedUpdateAsDataItemDelegateV2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getUpdateAsDataItemDelegateV2InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
