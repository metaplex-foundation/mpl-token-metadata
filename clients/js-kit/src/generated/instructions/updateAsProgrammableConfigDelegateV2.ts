...
export type UpdateAsProgrammableConfigDelegateV2Instruction<
...
export function getUpdateAsProgrammableConfigDelegateV2InstructionDataEncoder(): Encoder<UpdateAsProgrammableConfigDelegateV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['updateAsProgrammableConfigDelegateV2Discriminator', getU8Encoder()],
...
export function getUpdateAsProgrammableConfigDelegateV2InstructionDataDecoder(): Decoder<UpdateAsProgrammableConfigDelegateV2InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['updateAsProgrammableConfigDelegateV2Discriminator', getU8Decoder()],
    ['ruleSet', getRuleSetToggleDecoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getUpdateAsProgrammableConfigDelegateV2InstructionDataCodec(): Codec<
  UpdateAsProgrammableConfigDelegateV2InstructionDataArgs,
  UpdateAsProgrammableConfigDelegateV2InstructionData
> {
  return combineCodec(
    getUpdateAsProgrammableConfigDelegateV2InstructionDataEncoder(),
    getUpdateAsProgrammableConfigDelegateV2InstructionDataDecoder()
  );
}
...
>(
  input: UpdateAsProgrammableConfigDelegateV2AsyncInput<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
  ...
  UpdateAsProgrammableConfigDelegateV2Instruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
> {
  ...
  return Object.freeze({
    ...
    programAddress,
  } as UpdateAsProgrammableConfigDelegateV2Instruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
...
export type UpdateAsProgrammableConfigDelegateV2Input<
  TAccountAuthority extends string = string,
  TAccountDelegateRecord extends string = string,
  TAccountToken extends string = string,
  TAccountMint extends string = string,
...
export function getUpdateAsProgrammableConfigDelegateV2Instruction<
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: UpdateAsProgrammableConfigDelegateV2Input<
    TAccountAuthority,
    TAccountDelegateRecord,
    TAccountToken,
    TAccountMint,
...
export type ParsedUpdateAsProgrammableConfigDelegateV2Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: UpdateAsProgrammableConfigDelegateV2InstructionData;
};

export function parseUpdateAsProgrammableConfigDelegateV2Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedUpdateAsProgrammableConfigDelegateV2Instruction<
  TProgram,
  TAccountMetas
> {
  ...
  return {
    ...
    data: getUpdateAsProgrammableConfigDelegateV2InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
