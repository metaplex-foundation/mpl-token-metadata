...
export type DelegateTransferV1Instruction<
...
export function getDelegateTransferV1InstructionDataEncoder(): Encoder<DelegateTransferV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['delegateTransferV1Discriminator', getU8Encoder()],
      ['amount', getU64Encoder()],
      ['authorizationData', getOptionEncoder(getAuthorizationDataEncoder())],
    ]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_TRANSFER_V1_DISCRIMINATOR,
...
export function getDelegateTransferV1InstructionDataDecoder(): Decoder<DelegateTransferV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateTransferV1Discriminator', getU8Decoder()],
    ['amount', getU64Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateTransferV1InstructionDataCodec(): Codec<
  DelegateTransferV1InstructionDataArgs,
  DelegateTransferV1InstructionData
> {
  return combineCodec(
    getDelegateTransferV1InstructionDataEncoder(),
    getDelegateTransferV1InstructionDataDecoder()
  );
}
...
export type DelegateTransferV1AsyncInput<
...
> = {
  ...
  amount?: DelegateTransferV1InstructionDataArgs['amount'];
  authorizationData?: DelegateTransferV1InstructionDataArgs['authorizationData'];
  tokenStandard: DelegateTransferV1InstructionExtraArgs['tokenStandard'];
  tokenOwner?: DelegateTransferV1InstructionExtraArgs['tokenOwner'];
};

export async function getDelegateTransferV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateTransferV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDelegateTransferV1InstructionDataEncoder().encode(
      args as DelegateTransferV1InstructionDataArgs
    ),
    programAddress,
  } as DelegateTransferV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateTransferV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateTransferV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedDelegateTransferV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateTransferV1InstructionData;
};

export function parseDelegateTransferV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegateTransferV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateTransferV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
