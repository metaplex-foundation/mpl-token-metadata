import { Pda, PublicKey, TransactionBuilder, publicKey, transactionBuilder } from "@metaplex-foundation/umi";
...
export const printAsDelegate = (
    ...
    const holderDelegateRecord = input.holderDelegateRecord ?? findHolderDelegateRecordPda(context, {
    ...
    return transactionBuilder()
        ...
        .addRemainingAccounts({ pubkey: publicKey(holderDelegateRecord), isSigner: false, isWritable: true });
}