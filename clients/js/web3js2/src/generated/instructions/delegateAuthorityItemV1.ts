...
export type DelegateAuthorityItemV1Instruction<
...
export function getDelegateAuthorityItemV1InstructionDataEncoder(): Encoder<DelegateAuthorityItemV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['delegateAuthorityItemV1Discriminator', getU8Encoder()],
...
export function getDelegateAuthorityItemV1InstructionDataDecoder(): Decoder<DelegateAuthorityItemV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateAuthorityItemV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateAuthorityItemV1InstructionDataCodec(): Codec<
  DelegateAuthorityItemV1InstructionDataArgs,
  DelegateAuthorityItemV1InstructionData
> {
  return combineCodec(
    getDelegateAuthorityItemV1InstructionDataEncoder(),
    getDelegateAuthorityItemV1InstructionDataDecoder()
  );
}
...
export type DelegateAuthorityItemV1AsyncInput<
...
export async function getDelegateAuthorityItemV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateAuthorityItemV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateAuthorityItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegateAuthorityItemV1InstructionDataEncoder().encode(
      args as DelegateAuthorityItemV1InstructionDataArgs
    ),
  } as DelegateAuthorityItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateAuthorityItemV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateAuthorityItemV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: DelegateAuthorityItemV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedDelegateAuthorityItemV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateAuthorityItemV1InstructionData;
};

export function parseDelegateAuthorityItemV1Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedDelegateAuthorityItemV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateAuthorityItemV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
