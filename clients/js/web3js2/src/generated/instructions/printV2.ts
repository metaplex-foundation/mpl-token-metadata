...
export type PrintV2Instruction<
  ...
  TAccountHolderDelegateRecord extends string | IAccountMeta<string> = string,
...
export function getPrintV2InstructionDataEncoder(): Encoder<PrintV2InstructionDataArgs> {
...
export function getPrintV2InstructionDataDecoder(): Decoder<PrintV2InstructionData> {
...
export function getPrintV2InstructionDataCodec(): Codec<
