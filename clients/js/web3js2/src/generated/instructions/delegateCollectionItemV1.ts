...
export type DelegateCollectionItemV1Instruction<
...
export function getDelegateCollectionItemV1InstructionDataEncoder(): Encoder<DelegateCollectionItemV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['delegateCollectionItemV1Discriminator', getU8Encoder()],
      ['authorizationData', getOptionEncoder(getAuthorizationDataEncoder())],
    ]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_COLLECTION_ITEM_V1_DISCRIMINATOR,
      delegateCollectionItemV1Discriminator: 11,
    })
  );
}

export function getDelegateCollectionItemV1InstructionDataDecoder(): Decoder<DelegateCollectionItemV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateCollectionItemV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateCollectionItemV1InstructionDataCodec(): Codec<
  DelegateCollectionItemV1InstructionDataArgs,
  DelegateCollectionItemV1InstructionData
> {
  return combineCodec(
    getDelegateCollectionItemV1InstructionDataEncoder(),
    getDelegateCollectionItemV1InstructionDataDecoder()
  );
}
...
export type DelegateCollectionItemV1AsyncInput<
...
> = {
  ...
  authorizationData: DelegateCollectionItemV1InstructionDataArgs['authorizationData'];
  tokenStandard: DelegateCollectionItemV1InstructionExtraArgs['tokenStandard'];
  updateAuthority?: DelegateCollectionItemV1InstructionExtraArgs['updateAuthority'];
};

export async function getDelegateCollectionItemV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateCollectionItemV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateCollectionItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegateCollectionItemV1InstructionDataEncoder().encode(
      args as DelegateCollectionItemV1InstructionDataArgs
    ),
  } as DelegateCollectionItemV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateCollectionItemV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateCollectionItemV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: DelegateCollectionItemV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedDelegateCollectionItemV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateCollectionItemV1InstructionData;
};

export function parseDelegateCollectionItemV1Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedDelegateCollectionItemV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateCollectionItemV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
