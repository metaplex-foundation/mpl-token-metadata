...
export type DelegateUtilityV1Instruction<
...
export function getDelegateUtilityV1InstructionDataEncoder(): Encoder<DelegateUtilityV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['delegateUtilityV1Discriminator', getU8Encoder()],
...
export function getDelegateUtilityV1InstructionDataDecoder(): Decoder<DelegateUtilityV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateUtilityV1Discriminator', getU8Decoder()],
    ['amount', getU64Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateUtilityV1InstructionDataCodec(): Codec<
  DelegateUtilityV1InstructionDataArgs,
  DelegateUtilityV1InstructionData
> {
  return combineCodec(
    getDelegateUtilityV1InstructionDataEncoder(),
    getDelegateUtilityV1InstructionDataDecoder()
  );
}
...
export type DelegateUtilityV1AsyncInput<
...
export async function getDelegateUtilityV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateUtilityV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegateUtilityV1InstructionDataEncoder().encode(
      args as DelegateUtilityV1InstructionDataArgs
    ),
  } as DelegateUtilityV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateUtilityV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateUtilityV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedDelegateUtilityV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateUtilityV1InstructionData;
};

export function parseDelegateUtilityV1Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedDelegateUtilityV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateUtilityV1InstructionDataDecoder().decode(instruction.data),
  };
}
