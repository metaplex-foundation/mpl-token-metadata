...
// MANUAL ADDITION: Re-export "Seed" versions as aliases for PDA compatibility
// These are required by auto-generated PDA files but were not generated by Codama
export {
  getHolderDelegateRoleEncoder as getHolderDelegateRoleSeedEncoder,
  type HolderDelegateRoleArgs as HolderDelegateRoleSeedArgs,
} from './holderDelegateRole';
export {
  getMetadataDelegateRoleEncoder as getMetadataDelegateRoleSeedEncoder,
  type MetadataDelegateRoleArgs as MetadataDelegateRoleSeedArgs,
} from './metadataDelegateRole';
