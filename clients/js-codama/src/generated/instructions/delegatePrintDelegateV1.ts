...
export type DelegatePrintDelegateV1Instruction<
...
export function getDelegatePrintDelegateV1InstructionDataEncoder(): Encoder<DelegatePrintDelegateV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['delegatePrintDelegateV1Discriminator', getU8Encoder()],
...
export function getDelegatePrintDelegateV1InstructionDataDecoder(): Decoder<DelegatePrintDelegateV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegatePrintDelegateV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegatePrintDelegateV1InstructionDataCodec(): Codec<
  DelegatePrintDelegateV1InstructionDataArgs,
  DelegatePrintDelegateV1InstructionData
> {
  return combineCodec(
    getDelegatePrintDelegateV1InstructionDataEncoder(),
    getDelegatePrintDelegateV1InstructionDataDecoder()
  );
}
...
export type DelegatePrintDelegateV1AsyncInput<
...
export async function getDelegatePrintDelegateV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegatePrintDelegateV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegatePrintDelegateV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegatePrintDelegateV1InstructionDataEncoder().encode(
      args as DelegatePrintDelegateV1InstructionDataArgs
    ),
  } as DelegatePrintDelegateV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegatePrintDelegateV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegatePrintDelegateV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: DelegatePrintDelegateV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedDelegatePrintDelegateV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegatePrintDelegateV1InstructionData;
};

export function parseDelegatePrintDelegateV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegatePrintDelegateV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegatePrintDelegateV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
