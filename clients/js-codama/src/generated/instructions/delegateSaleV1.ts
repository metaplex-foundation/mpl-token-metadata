...
export type DelegateSaleV1Instruction<
...
export function getDelegateSaleV1InstructionDataEncoder(): Encoder<DelegateSaleV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['delegateSaleV1Discriminator', getU8Encoder()],
      ['amount', getU64Encoder()],
      ['authorizationData', getOptionEncoder(getAuthorizationDataEncoder())],
    ]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_SALE_V1_DISCRIMINATOR,
...
export function getDelegateSaleV1InstructionDataDecoder(): Decoder<DelegateSaleV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateSaleV1Discriminator', getU8Decoder()],
    ['amount', getU64Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateSaleV1InstructionDataCodec(): Codec<
  DelegateSaleV1InstructionDataArgs,
  DelegateSaleV1InstructionData
> {
  return combineCodec(
    getDelegateSaleV1InstructionDataEncoder(),
    getDelegateSaleV1InstructionDataDecoder()
  );
}
...
>(
  input: DelegateSaleV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegateSaleV1InstructionDataEncoder().encode(
      args as DelegateSaleV1InstructionDataArgs
    ),
  } as DelegateSaleV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateSaleV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export type ParsedDelegateSaleV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateSaleV1InstructionData;
};

export function parseDelegateSaleV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegateSaleV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateSaleV1InstructionDataDecoder().decode(instruction.data),
  };
}
