...
export type DelegateLockedTransferV1Instruction<
...
export function getDelegateLockedTransferV1InstructionDataEncoder(): Encoder<DelegateLockedTransferV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['delegateLockedTransferV1Discriminator', getU8Encoder()],
...
export function getDelegateLockedTransferV1InstructionDataDecoder(): Decoder<DelegateLockedTransferV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateLockedTransferV1Discriminator', getU8Decoder()],
...
export function getDelegateLockedTransferV1InstructionDataCodec(): Codec<
  DelegateLockedTransferV1InstructionDataArgs,
  DelegateLockedTransferV1InstructionData
> {
  return combineCodec(
    getDelegateLockedTransferV1InstructionDataEncoder(),
    getDelegateLockedTransferV1InstructionDataDecoder()
  );
}
...
>(
  input: DelegateLockedTransferV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateLockedTransferV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  } as DelegateLockedTransferV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateLockedTransferV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateLockedTransferV1Instruction<
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: DelegateLockedTransferV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedDelegateLockedTransferV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateLockedTransferV1InstructionData;
};

export function parseDelegateLockedTransferV1Instruction<
...
>(
  ...
  return {
    ...
    data: getDelegateLockedTransferV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
