...
export type RevokeStandardV1Instruction<
...
export function getRevokeStandardV1InstructionDataEncoder(): FixedSizeEncoder<RevokeStandardV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['revokeStandardV1Discriminator', getU8Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REVOKE_STANDARD_V1_DISCRIMINATOR,
      revokeStandardV1Discriminator: 6,
    })
  );
}

export function getRevokeStandardV1InstructionDataDecoder(): FixedSizeDecoder<RevokeStandardV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['revokeStandardV1Discriminator', getU8Decoder()],
  ]);
}

export function getRevokeStandardV1InstructionDataCodec(): FixedSizeCodec<
  RevokeStandardV1InstructionDataArgs,
  RevokeStandardV1InstructionData
> {
  return combineCodec(
    getRevokeStandardV1InstructionDataEncoder(),
    getRevokeStandardV1InstructionDataDecoder()
  );
}
...
export type RevokeStandardV1AsyncInput<
...
> = {
  ...
  tokenStandard: RevokeStandardV1InstructionExtraArgs['tokenStandard'];
  tokenOwner?: RevokeStandardV1InstructionExtraArgs['tokenOwner'];
};

export async function getRevokeStandardV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: RevokeStandardV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getRevokeStandardV1InstructionDataEncoder().encode({}),
  } as RevokeStandardV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type RevokeStandardV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getRevokeStandardV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
export type ParsedRevokeStandardV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RevokeStandardV1InstructionData;
};

export function parseRevokeStandardV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevokeStandardV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRevokeStandardV1InstructionDataDecoder().decode(instruction.data),
  };
}
