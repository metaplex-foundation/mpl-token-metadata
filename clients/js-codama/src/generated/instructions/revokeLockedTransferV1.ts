...
export type RevokeLockedTransferV1Instruction<
...
export function getRevokeLockedTransferV1InstructionDataEncoder(): FixedSizeEncoder<RevokeLockedTransferV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['revokeLockedTransferV1Discriminator', getU8Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REVOKE_LOCKED_TRANSFER_V1_DISCRIMINATOR,
      revokeLockedTransferV1Discriminator: 7,
    })
  );
}

export function getRevokeLockedTransferV1InstructionDataDecoder(): FixedSizeDecoder<RevokeLockedTransferV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['revokeLockedTransferV1Discriminator', getU8Decoder()],
  ]);
}

export function getRevokeLockedTransferV1InstructionDataCodec(): FixedSizeCodec<
  RevokeLockedTransferV1InstructionDataArgs,
  RevokeLockedTransferV1InstructionData
> {
  return combineCodec(
    getRevokeLockedTransferV1InstructionDataEncoder(),
    getRevokeLockedTransferV1InstructionDataDecoder()
  );
}
...
export type RevokeLockedTransferV1AsyncInput<
...
> = {
  ...
  tokenStandard: RevokeLockedTransferV1InstructionExtraArgs['tokenStandard'];
  tokenOwner?: RevokeLockedTransferV1InstructionExtraArgs['tokenOwner'];
};

export async function getRevokeLockedTransferV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: RevokeLockedTransferV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  RevokeLockedTransferV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getRevokeLockedTransferV1InstructionDataEncoder().encode({}),
  } as RevokeLockedTransferV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type RevokeLockedTransferV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getRevokeLockedTransferV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: RevokeLockedTransferV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedRevokeLockedTransferV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RevokeLockedTransferV1InstructionData;
};

export function parseRevokeLockedTransferV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRevokeLockedTransferV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRevokeLockedTransferV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
