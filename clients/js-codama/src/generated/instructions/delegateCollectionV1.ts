...
export type DelegateCollectionV1Instruction<
...
export function getDelegateCollectionV1InstructionDataEncoder(): Encoder<DelegateCollectionV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', getU8Encoder()],
      ['delegateCollectionV1Discriminator', getU8Encoder()],
      ['authorizationData', getOptionEncoder(getAuthorizationDataEncoder())],
    ]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_COLLECTION_V1_DISCRIMINATOR,
...
export function getDelegateCollectionV1InstructionDataDecoder(): Decoder<DelegateCollectionV1InstructionData> {
  return getStructDecoder([
    ['discriminator', getU8Decoder()],
    ['delegateCollectionV1Discriminator', getU8Decoder()],
    ['authorizationData', getOptionDecoder(getAuthorizationDataDecoder())],
  ]);
}

export function getDelegateCollectionV1InstructionDataCodec(): Codec<
  DelegateCollectionV1InstructionDataArgs,
  DelegateCollectionV1InstructionData
> {
  return combineCodec(
    getDelegateCollectionV1InstructionDataEncoder(),
    getDelegateCollectionV1InstructionDataDecoder()
  );
}
...
export type DelegateCollectionV1AsyncInput<
...
> = {
  ...
  authorizationData?: DelegateCollectionV1InstructionDataArgs['authorizationData'];
  tokenStandard: DelegateCollectionV1InstructionExtraArgs['tokenStandard'];
  updateAuthority?: DelegateCollectionV1InstructionExtraArgs['updateAuthority'];
};

export async function getDelegateCollectionV1InstructionAsync<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
...
>(
  input: DelegateCollectionV1AsyncInput<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
  ...
  DelegateCollectionV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDelegateCollectionV1InstructionDataEncoder().encode(
      args as DelegateCollectionV1InstructionDataArgs
    ),
  } as DelegateCollectionV1Instruction<
    TProgramAddress,
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
...
export type DelegateCollectionV1Input<
  TAccountDelegateRecord extends string = string,
  TAccountDelegate extends string = string,
  TAccountMetadata extends string = string,
  TAccountMasterEdition extends string = string,
...
export function getDelegateCollectionV1Instruction<
  TAccountDelegateRecord extends string,
  TAccountDelegate extends string,
  TAccountMetadata extends string,
  TAccountMasterEdition extends string,
  ...
  TProgramAddress extends Address = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
  input: DelegateCollectionV1Input<
    TAccountDelegateRecord,
    TAccountDelegate,
    TAccountMetadata,
    TAccountMasterEdition,
...
export type ParsedDelegateCollectionV1Instruction<
  TProgram extends string = typeof MPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegateCollectionV1InstructionData;
};

export function parseDelegateCollectionV1Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDelegateCollectionV1Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegateCollectionV1InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
