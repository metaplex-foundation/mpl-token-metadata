...
export function getUpdateAsDataDelegateV2InstructionDataEncoder(): Encoder<UpdateAsDataDelegateV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: UPDATE_AS_DATA_DELEGATE_V2_DISCRIMINATOR,
...
export function getUpdateAsDataDelegateV2InstructionDataDecoder(): Decoder<UpdateAsDataDelegateV2InstructionData> {
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getUpdateAsDataDelegateV2InstructionDataEncoder().encode(
