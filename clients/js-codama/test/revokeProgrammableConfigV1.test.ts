/**
 * RevokeProgrammableConfigV1 tests for js-codama client
 *
 * Programmable Config delegates are metadata-level delegates that can manage
 * programmable configurations. They work for all non-edition token standards.
 *
...
/**
 * Test: Revoke programmable config delegate for NonFungible
 */
test('it can revoke a programmable config delegate for a NonFungible', async (t) => {
  ...
  // Revoke the programmable config delegate
  const revokeInstruction = await getRevokeProgrammableConfigV1InstructionAsync({
    mint: mint.address,
    authority: updateAuthority,
    payer: updateAuthority,
    delegate: programmableConfigDelegate.address,
...
/**
 * Test: Revoke programmable config delegate for ProgrammableNonFungible
 */
...
/**
 * Test: Revoke programmable config delegate for Fungible
 */
...
/**
 * Test: Revoke programmable config delegate for FungibleAsset
 */
