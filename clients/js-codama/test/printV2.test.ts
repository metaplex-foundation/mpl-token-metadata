/**
 * PrintV2 tests for js-codama client
 *
 * The printV2 instruction is similar to printV1 but adds support for print delegates,
 * allowing delegated printing without escrow.
 *
...
/**
 * Test: Print a new edition from a NonFungible master edition using printV2
 */
...
/**
 * Test: Print a new edition from a ProgrammableNonFungible master edition using printV2
 */
