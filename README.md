![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/metaplex-foundation/mpl-token-metadata/main.yml?style=flat-square&logo=GitHub)
...
![npm](https://img.shields.io/npm/v/%40metaplex-foundation%2Fmpl-token-metadata?logo=npm&style=flat-square&color=377CC0)
![Crates.io](https://img.shields.io/crates/v/mpl-token-metadata?logo=rust&style=flat-square)
