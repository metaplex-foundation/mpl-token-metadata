...
OUTPUT=$1
EXTERNAL_ID=("auth9SigNpDKz4sJJ1DfCTuZrZNSAgh9sFD3rboVmgg" "SysExL2WDyJi9aRZrXorrjHJut3JwHQ7R9bTyctbNNG" "TokExjvjJmhKaRBShsBAsbSvEWMA1AgUNK7ps4SAc2p" "Roostrnex2Z9Y2XZC49sFAdZARP8E4iFpEnZC5QJWdz" "ENGRVY4DL6uKDnNS91hCkJMwzTfcofYpkZH8zsgJfzA3")
EXTERNAL_SO=("mpl_token_auth_rules.so" "mpl_system_extras.so" "mpl_token_extras.so" "rooster.so" "mpl_engraver.so")
